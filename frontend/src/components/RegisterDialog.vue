  ...
  <transition name="fade">
    ...
    >
      ...
      >
        ...
        >
          <h5 class="text-xl font-medium p-4">Inscription</h5>
          <div class="relative p-4">
            Veuillez fournir les informations suivantes pour vous créer un compte :
          </div>
          ...
          >
            ...
            <Field
              ...
              type="text"
              name="name"
              class="border-2 pl-2 mb-4 rounded border-orange-500 bg-gray-500 focus:bg-gray-500 w-3/4"
            />
          ...
          >
            <button type="button" class="btn-secondary" @click="closeRegister">
              Annuler
            </button>
            <button @click="handleRegister" class="btn-primary ml-1 mb-3 sm:mb-0">
              Inscription
            </button>
          </div>
        </div>
...
export default {
  setup() {
    ...
    return { registerDialogStore, userDataStore };
  },
  components: {
    Form,
    Field,
  ...
  computed: {
    ...mapState(useRegisterDialogStore, {
      showRegister: "registerDialog",
    }),
  },
  methods: {
    closeRegister() {
      this.registerDialogStore.closeRegister();
    },

    async handleRegister() {
      const [error, data] = await this.userDataStore.registerUser(this.user);
